  ...
  return (
    <div className="grid gap-6">
      <section className="rounded-3xl border border-slate-800 bg-slate-900/70 p-6">
        <p className="text-sm font-semibold uppercase tracking-[0.3em] text-emerald-300">Manager project view</p>
        <h1 className="mt-3 text-3xl font-semibold text-white">Department workspace</h1>
      </section>
      <ProjectDetailPanel project={project} reportBasePath="/manager/reports" />
    </div>
  );
}
