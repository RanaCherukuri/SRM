  ...
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-5xl flex-col justify-center gap-8 px-6 py-10 lg:flex-row lg:items-center">
      <section className="max-w-xl space-y-4">
        <p className="text-sm font-semibold uppercase tracking-[0.3em] text-sky-300">SRM</p>
        <h1 className="text-4xl font-semibold text-white">Secure status reporting frontend</h1>
